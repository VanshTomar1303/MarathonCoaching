...
export const metadata: Metadata = {
  title: "About Us",
  description: `The story, mission, and teaching philosophy behind ${site.name} — Kolkata's IIT-JEE, NEET and WBJEE coaching institute since 2011.`,
};
...
const timeline = [
  { year: "2011", text: "Marathon Academy founded in Salt Lake, Kolkata, with a single batch and a simple goal: teach IIT-JEE properly." },
  { year: "2014", text: "First alumni cohort enters IIT Bombay, IIT Kharagpur and other top institutes, and word-of-mouth growth begins." },
  { year: "2017", text: "Introduced the Marathon Academy Smart Test (MAST) system for internal ranking and performance analytics." },
  { year: "2019", text: "Extended coaching to NEET and WBJEE aspirants alongside the core JEE programs." },
  { year: "2020", text: "Launched online live classes and a full digital learning platform for remote students." },
  { year: "2026", text: "Over a decade of continuous JEE/NEET/WBJEE results, with alumni across the IITs, NITs, BITS, ISI, CMI and leading medical colleges." },
];
    ...
    <>
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <RevealOnScroll>
            ...
            <h1 className="font-display font-semibold text-4xl sm:text-5xl tracking-tight text-balance">
              Building India&apos;s next generation of engineers and doctors, since 2011
            </h1>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <RevealOnScroll delay={0.1}>
            ...
            <p className="text-foreground/65 leading-relaxed mb-4">
              Marathon Academy began with a single batch in Salt Lake, Kolkata, and a simple
              conviction: that clearing India&apos;s toughest entrance exams isn&apos;t about
              covering more, it&apos;s about understanding deeply. That principle — small
              batches, individual attention, and faculty who stay accountable for every
              student&apos;s progress — still defines how every class runs today.
            </p>
            <p className="text-foreground/65 leading-relaxed">
              Over a decade later, that same philosophy has taken students from Class IX
              foundation batches all the way to IITs, NITs, BITS, ISI, CMI, and leading medical
              colleges — while keeping the institute small enough that no student is ever just a
              name on a register.
            </p>
          </RevealOnScroll>
        </div>
      ...
      <section className="relative py-28">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <RevealOnScroll className="max-w-2xl mb-16">
            <p className="text-sm font-medium text-gold uppercase tracking-wider mb-3">Our Journey</p>
            <h2 className="font-display font-semibold text-3xl sm:text-4xl tracking-tight text-balance">
              Since 2011
            </h2>
          </RevealOnScroll>
          <div className="relative pl-8 border-l border-border-subtle space-y-10">
            {timeline.map((t, i) => (
              <RevealOnScroll key={t.year} delay={i * 0.06} className="relative">
                ...
                <p className="font-display font-semibold text-navy text-xl mb-1.5">{t.year}</p>
